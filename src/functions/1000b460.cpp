...
extern "C" std::uint8_t LAB_1000c900[];
extern "C" std::uint8_t LAB_1000c8f0[];
extern "C" std::uint8_t LAB_1000c8e0[];
extern "C" std::uint8_t LAB_1000c8d0[];
extern "C" std::uint8_t LAB_1000c8c0[];
...
struct __single_inheritance FUN_1000b460_this {
    void __thiscall FUN_1000b460(std::uint32_t param_1, int param_2, int param_3, int param_4, int param_5);
};

void FUN_1000b460_this::FUN_1000b460(std::uint32_t param_1, int param_2, int param_3, int param_4, int param_5)
{
