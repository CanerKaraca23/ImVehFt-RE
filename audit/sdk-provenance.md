...
The resulting `Plugin2014.lib` was added to the same strict 705-object diagnostic link used with the modern SDK. Before address shims, both probes reported 228 unresolved externals and produced no DLL. The first 2026-09-24 address-shim probe reached 208. After evidence-backed candidate fixes, the latest diagnostic link against the updated 705-object set reports 200 unresolved externals, still with no DLL. This is a symbol-resolution experiment, not proof that the SDK vintage or inferred call behavior matches the original build. See [`link-probe-2026-09-24.md`](link-probe-2026-09-24.md), [`candidate-correction-10003ba0-10003e60.md`](candidate-correction-10003ba0-10003e60.md), [`candidate-correction-100076d0.md`](candidate-correction-100076d0.md), and [`candidate-correction-100099f0.md`](candidate-correction-100099f0.md).
